...
namespace Bitfinex.Client.Websocket.Validations
{
    internal static class BfxValidations
    {
        ...
        /// <summary>
        /// It throws <exception cref="BitfinexBadInputException"></exception> if value is null
        /// </summary>
        /// <param name="value">The value to be validated</param>
        /// <param name="name">Input parameter name</param>
        ...
        /// <summary>
        /// It throws <exception cref="BitfinexBadInputException"></exception> if collection is null or collection is empty
        /// </summary>
        ...
        /// <summary>
        /// It throws <exception cref="BitfinexBadInputException"></exception> if value is not in specified range
        /// </summary>
        /// <param name="value">The value to be validated</param>
        /// <param name="name">Input parameter name</param>
